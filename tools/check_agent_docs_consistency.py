...
REQUIRED_TERMS_BY_FILE: dict[Path, list[str]] = {
    Path("AGENTS.md"): [
        "Semantische Räume", "Sprechakt", "Task-Schnitt", "Abbruch",
        "Schreibrechte", "Preflight",
        "package-schema.md", "AGENTS-COMPACT.md",
        "migration-bridges.md", "erfahrungsbericht-protokoll.md",
        "grundsatz.md", "glossar-domain.md",
        "Autonomieregel", "H10",
    ],
    Path("AGENTS-COMPACT.md"): [
        "Semantische Räume", "Sprechakte", "Task-Schnitt",
        "Abbruchbedingungen", "Preflight",
        "AGENTS.md", "glossar-domain.md",
        "Autonomieregel", "H10", "decision",
    ],
    Path("AGENT-SETUP.md"): [
    ...
    Path("regelmatrix.md"): [
        "Autoritätsreihenfolge", "AGENTS.md",
        "package-schema.md", "Widerspruch", "grundsatz.md",
    ],
    Path("test-obligations.md"): [
    ...
    Path("glossar-README.md"): [
        ...
        "migration-bridges.md", "SP7", "T1", "Autonomieregel",
    ],
    Path(".agent-box-template.md"): [
        "Box-Version", "Markdown only", "Template-Dateien",
        "Instanziierungsnachweis", ".agent-box/instantiation.md",
    ],
    Path("docs/plans/template.md"): [
        "Status:", "Aufgabe", "Betroffene Räume", "Testpflicht",
...
COUPLING_HINTS: dict[str, list[str]] = {
    ...
    "AGENTS.md": [
        "AGENTS-COMPACT.md", "preflight-checkliste.md", "task-schnitt.md",
        "sprechakt-protokoll.md", "regelmatrix.md",
        "migration-bridges.md", "erfahrungsbericht-protokoll.md",
        "grundsatz.md", "glossar-README.md",
    ],
    "AGENTS-COMPACT.md": ["AGENTS.md"],
    "package-schema.md": [
        "AGENTS.md", "AGENTS-COMPACT.md", "test-obligations.md",
    ...
    "glossar-README.md": [
        "AGENTS.md", "glossar-domain.md", "glossar-system.md", "preflight-checkliste.md",
    ],
    ...
    "preflight-checkliste.md": [
        "AGENTS.md", "AGENTS-COMPACT.md", "regelmatrix.md", "glossar-README.md",
    ],
    "task-schnitt.md": [
        "AGENTS.md", "preflight-checkliste.md", "sprechakt-protokoll.md",
    ],
    "sprechakt-protokoll.md": [
        "AGENTS.md", "task-schnitt.md", "preflight-checkliste.md", "migration-bridges.md",
    ],
    "test-obligations.md": [
...
def check_experience_trigger_sync() -> list[Finding]:
    ...
    for path in [Path("AGENTS.md"), Path("AGENTS-COMPACT.md"), Path("erfahrungsbericht-protokoll.md")]:
        if not path.exists():
            continue
        text = read_text(path)
